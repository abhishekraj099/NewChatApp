plugins {
    ...
    kotlin("plugin.serialization") version "2.0.20" // Ensure this matches your Kotlin version
...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = libs.versions.composeBom.get() // Use BOM version for Compose compiler extension
    }
